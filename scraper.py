...
INTL_FEEDS = [
    ...
    *[(f'https://parks.qld.gov.au/xml/rss/parkalerts-{r}.xml',
    ...
    # INTL 3 — Google News for English-speaking countries not covered by park agency feeds
    ('https://news.google.com/rss/search?q=trail+closed&hl=en-CA&gl=CA&ceid=CA:en',
     'INTL 3', 'Google News – Canada (trail closed)'),
    ('https://news.google.com/rss/search?q=footpath+closed+OR+trail+closed&hl=en-GB&gl=GB&ceid=GB:en',
     'INTL 3', 'Google News – UK (trail/footpath closed)'),
    ('https://news.google.com/rss/search?q=trail+closed&hl=en-IE&gl=IE&ceid=IE:en',
     'INTL 3', 'Google News – Ireland (trail closed)'),
    ...
    ('https://news.google.com/rss/search?q=sendero+cerrado&hl=es&gl=MX&ceid=MX:es',
     'INTL 1', 'Google News – Mexico (sendero cerrado)'),
    ...
    ('https://news.google.com/rss/search?q=sendero+cerrado&hl=es&gl=CO&ceid=CO:es',
     'INTL 1', 'Google News – Colombia (sendero cerrado)'),
    ('https://news.google.com/rss/search?q=sendero+cerrado&hl=es&gl=CL&ceid=CL:es',
     'INTL 1', 'Google News – Chile (sendero cerrado)'),
    ('https://news.google.com/rss/search?q=trilha+fechada&hl=pt-BR&gl=BR&ceid=BR:pt-419',
     'INTL 1', 'Google News – Brazil (trilha fechada)'),
    ('https://news.google.com/rss/search?q=trilho+fechado&hl=pt&gl=PT&ceid=PT:pt-150',
     'INTL 1', 'Google News – Portugal (trilho fechado)'),
    ...
    ('https://news.google.com/rss/search?q=trail+closed&hl=en-IN&gl=IN&ceid=IN:en',
     'INTL 1', 'Google News – India (trail closed)'),
    ...
    ('https://news.google.com/rss/search?q=Wanderweg+gesperrt&hl=de&gl=AT&ceid=AT:de',
     'INTL 2', 'Google News – Austria (Wanderweg gesperrt)'),
    ('https://news.google.com/rss/search?q=Wanderweg+gesperrt&hl=de&gl=CH&ceid=CH:de',
     'INTL 2', 'Google News – Switzerland (Wanderweg gesperrt)'),
    ...
    ('https://news.google.com/rss/search?q=sentier+ferm%C3%A9&hl=fr&gl=BE&ceid=BE:fr',
     'INTL 2', 'Google News – Belgium (sentier fermé)'),
    ...
    ('https://news.google.com/rss/search?q=polku+suljettu&hl=fi&gl=FI&ceid=FI:fi',
     'INTL 2', 'Google News – Finland (polku suljettu)'),
    ('https://news.google.com/rss/search?q=sti+lukket&hl=da&gl=DK&ceid=DK:da',
     'INTL 2', 'Google News – Denmark (sti lukket)'),
    ('https://news.google.com/rss/search?q=szlak+zamkni%C4%99ty&hl=pl&gl=PL&ceid=PL:pl',
     'INTL 2', 'Google News – Poland (szlak zamknięty)'),
    ('https://news.google.com/rss/search?q=stezka+uzav%C5%99ena&hl=cs&gl=CZ&ceid=CZ:cs',
     'INTL 2', 'Google News – Czech Republic (stezka uzavřena)'),
    ('https://news.google.com/rss/search?q=%CE%BC%CE%BF%CE%BD%CE%BF%CF%80%CE%AC%CF%84%CE%B9+%CE%BA%CE%BB%CE%B5%CE%B9%CF%83%CF%84%CF%8C&hl=el&gl=GR&ceid=GR:el',
     'INTL 2', 'Google News – Greece (μονοπάτι κλειστό)'),
]
